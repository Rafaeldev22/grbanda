          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="space-y-4">
              <div className="inline-block bg-orange-500/10 border border-orange-500/30 rounded-full px-4 py-2">
                <span className="text-orange-500 font-semibold text-sm">Virtual Sound Experience</span>
              </div>
              ...
              <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                ...
                <br />
                <span className="text-gray-400 text-4xl md:text-5xl">+ Tecnologia</span>
              </h1>
            </div>

            <p className="text-gray-300 text-lg md:text-xl leading-relaxed">
              Experimente o melhor dos dois mundos: a emoção de músicos ao vivo combinada com a
              perfeição do Virtual Sound. Uma banda completa para tornar seu evento inesquecível.
            </p>
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border-4 border-orange-500/50 shadow-2xl">
                <img
                  src="https://images.pexels.com/photos/1751731/pexels-photo-1751731.jpeg?auto=compress&cs=tinysrgb&w=1200"
                  alt="Cantor VS Band"
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-black/80 backdrop-blur-sm rounded-lg p-4 border border-orange-500/30">
                    <p className="text-orange-500 font-bold text-xl">Vocalista VS Band</p>
                    <p className="text-gray-300 text-sm">Energia e talento em cada apresentação</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 shadow-2xl hidden md:block">
                <p className="text-black font-bold text-3xl">500+</p>
